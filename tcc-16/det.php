...
function adicionarComentario($conn, $livro_id, $usuario_id, $comentario) {
    $sql = "INSERT INTO comentario (usuario_id, livro_id, mensagem) VALUES (?, ?, ?)";
    $stmt = mysqli_prepare($conn, $sql);

    if ($stmt) {
        mysqli_stmt_bind_param($stmt, "iis", $usuario_id, $livro_id, $comentario);
...
if (isset($_POST['comentario'])) {
    ...
    if (adicionarComentario($conn, $livro_id, $usuario_id, $comentario)) {
